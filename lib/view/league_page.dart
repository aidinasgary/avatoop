            ...
            child: ListView(
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    GestureDetector(
                      child: LeagueContainer(image: 'assets/images/premier_league.png'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image: 'assets/images/laliga_league.png'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image: 'assets/images/Bundesliga_league.png'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image: 'assets/images/seraie_a_league.jpg'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image: 'assets/images/ligue_1.png'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image:'assets/images/bartar_league.jpg'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    GestureDetector(
                      child: LeagueContainer(image:'assets/images/azadegan_league.jpg'),
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
